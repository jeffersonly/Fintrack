...
import SplitEven from '../Pages/SplitEven';
import SplitItem from '../Pages/SplitItem';
        ...
        <div className="App">
            <Router>
                ...
                <Switch>
                    ...
                    <AuthenticatedRoute exact path="/splitEven" component={SplitEven} appProps={{userAuthenticated, setUserAuthenticated}} />
                    <AuthenticatedRoute exact path="/splitItem" component={SplitItem} appProps={{userAuthenticated, setUserAuthenticated}} />
